package polito.tdp.librettoVL.model;
	 ...
	 * costruttore
	 * metodi get/set
	 * metodi di servizio: (equals, toString, hash code, [compare to]) 
	...
	public class Esame {
		...
		/**
		 * Dobbiamo decidere se il docente fa parte di un elenco[nuova classe]
		 * oppure è una semplice stringa.
		 * 
		 * In generale la soluzione giusta è: avere elenco di docenti.
		 * PER QUESTA VOLTA UTILIZZIAMO IL DOCENTE COME UN SEMPLICE ATTRIBUTO DEL CORSO!
		 */
